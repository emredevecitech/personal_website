            ...
            <div className="space-y-6">
              <div className="flex">
                ...
                <div className="ml-4">
                  ...
                  <p className="mt-1 text-gray-300">emredeveci.tech@gmail.com</p>
                </div>
              </div>
              ...
              <div className="flex">
                ...
                <div className="ml-4">
                  ...
                  <p className="mt-1 text-gray-300">(+49)-159-011-47371</p>
                </div>
              </div>
              ...
              <div className="flex">
                ...
                <div className="ml-4">
                  ...
                  <p className="mt-1 text-gray-300">Bremen, Germany 28359</p>
                </div>
              </div>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                <button
                  ...
                  className={`w-full py-3 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white focus:outline-none ${
              ...
              {submitStatus === 'success' && (
                <div className="bg-green-900 border-l-4 border-green-500 text-green-200 p-4 rounded">
